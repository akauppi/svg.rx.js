...
(function() {
  ...
  */
  SVG.extend( SVG.Doc, {
    ...
    //
    // When called for the 'SVG.Doc', an observable is returned that will get a message when a touch (first touch)
    // within the SVG happens.
    //
    ...
    //    by '.rx_multitouch', but for the next level (2nd) concurrent touch. The limit of how many simultaneous touches
    ...
    //
    rx_multitouch: function () {   // () ->

      var self = this;    // to be used within further inner functions

      alert( "tbd. implementation missing" );
    }
  });
