...
describe('gx', function () {    // Test all 'gx' operations
  ...
  /*** disabled until above works AKa050516
  it ('should be moveable', function () {
    var X= 200;
    var Y= 100;
    create().pos(4*X,5*Y).pos(X,Y);   // only the last '.pos' should matter
  ...
  it ('should be relatively moveable', function () {
    var DX= 20;
    var DY= 10;
  ...
  it ('should be possible to read the position', function () {
    var X= 100;
    var Y= 200;
